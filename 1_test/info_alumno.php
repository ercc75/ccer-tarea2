...
<body>
    ...
    <div class="container" style="padding-top: 80px; padding-bottom: 30px; height: 90vh; overflow-y: auto">
        ...
        <div class="bg-white p-3 col-3">
            <form action="info_alumno2.php" method="post">
                <input type="text" class="form-control" name="nombre" placeholder="Nombre de usuario del alumno" required="required" /><br />
